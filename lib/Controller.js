...
var Controller = function (options) {
  ...
  self.model.on('created', function(obj){ Utils.bind(self.created, self)(obj); });
  self.model.on('updated', function(obj){ Utils.bind(self.updated, self)(obj); });
  self.model.on('deleted', function(obj){ Utils.bind(self.deleted, self)(obj); });
